...
<head>
    ...
    <!-- for Facebook -->
    <meta property="og:title" content="Learn and Earn, Bank PO, SSC, SSC CGL, Solve Question and earn back money. Increase you chance to get selected." />
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="page-scroll" href="https://examhans.com/members/#/?rt=demo">Demo Test</a>
                    </li>
    ...
    <header>
        <div class="container">
            <div class="intro-text" style="padding-top: 100px;">
                <img src="img/logos/examhans_logo.png" style="max-width: 25%;"/>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading text-muted">Our Focus is to bring Best out of you!</h3>
                </div>
            </div>
            <div class="row text-center">
                <div class="col-md-4">
                    ...
                    <h4 class="service-heading">Become A Member</h4>
                    <p class="text-muted">You can buy our Silver, Gold or Platinum plan for becoming a member of ExamHans.com <a href="member/" >Register</a> </p>
                </div>
                <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                        <i class="fa fa-circle fa-stack-2x text-primary"></i>
                    ...
                    <h4 class="service-heading">Daily/Weekly Test</h4>
                    <p class="text-muted">You need to solve 100 Questions in a week/daily. You can select to topic from the Dashboard. There will be limited question from a topic depend on the type of exam your are preparing for.</p>
                </div>
                <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                        <i class="fa fa-circle fa-stack-2x text-primary"></i>
                    ...
                    <p class="text-muted">Every right Answer will pay you 5 Rs. You can answer to 2,000 Question that will give you chance to earn 10,000 Rs</p>
                </div>
            </div>
            <br>
            <br>
            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">Let's Ignite the Exam this time!</h2>
                    <h3 class="section-subheading text-muted">We will also give Free of cost suggeston to you. Which topic of your is week.
                    <br> <a href="blog/">Know More</a> </h3>
